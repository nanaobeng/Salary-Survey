...
class Client(db.Model):
    ...
    qualitative = db.relationship('Qualitative_survey', backref='client_qual' , lazy=True)
...
class Survey_comparator(db.Model):
    ...
    status = db.Column(db.String(100))
    comparator_job = db.relationship('Comparator_job', backref='comparator' , lazy=True)
...
class Benchmark_job(db.Model):
    ...
    comparator_job = db.relationship('Comparator_job', backref='benchmark' , lazy=True)
...
class Qualitative_survey(db.Model):
    ...
    overtime_policy = db.Column(db.Text)
    haveSalaryStructure = db.Column(db.Integer)
    salary_structure = db.Column(db.Text)
    ...
    adjusment_basis = db.Column(db.Text)
    ...
    other_indicator = db.Column(db.Text)
    isGradesAdjustedBySamePerc = db.Column(db.Integer)
    detailed_adjustments = db.Column(db.Text)
    job_evaluation = db.Column(db.Text)
    periodic_salary_increases = db.Column(db.Text)
    cost_of_living_adjustments_periodically = db.Column(db.Integer)
    cost_of_living_adjustments_periodically_basis = db.Column(db.Text)
    grade_levels = db.Column(db.Integer)
    perc_grade_difference = db.Column(db.Text)
    ...
    other_scale = db.Column(db.Text)
    hiring_rate = db.Column(db.Text)
    max_salary_grade = db.Column(db.Integer)
    max_salary_exceeded = db.Column(db.Integer)
    max_salary_exceeded_reason = db.Column(db.Text)
    haveIncentivePlans = db.Column(db.Integer)
    incentive_plans = db.Column(db.Text)
    ...
    restrictions_13 = db.Column(db.Text)
    direct_compensation = db.Column(db.Text)
    annual_leave_days = db.Column(db.Integer)
    staff_categories = db.Column(db.Text)
    ...
    other_leave = db.Column(db.Text)
    entitlement_rates = db.Column(db.Text)
    redundancy_exercises = db.Column(db.Text)
    exiting_staff_payment = db.Column(db.Text)
    org_subsidise_transport = db.Column(db.Integer)
    org_subsidise_transport_yes = db.Column(db.Text)
    car_scheme = db.Column(db.Integer)
    car_scheme_yes = db.Column(db.String(200))
    car_market_val = db.Column(db.Integer)
    car_tax_issue = db.Column(db.Text)
    meals_senior_mgmt = db.Column(db.Integer)
    meals_senior_mgmt_yes = db.Column(db.Text)
    clothing_allowance = db.Column(db.String(100))
    grades_clothing_allowance = db.Column(db.String(200))
    travel_policy = db.Column(db.Text)
    loan_interest = db.Column(db.Text)
    housing_benefits = db.Column(db.Text)
    education_subsidy = db.Column(db.Text)
    provisions = db.Column(db.Text)
    entertainment_allowance = db.Column(db.Text)
    vacation_related_benefits = db.Column(db.Integer)
    entitlement_description = db.Column(db.Text)
    medical_scheme = db.Column(db.Text)
    family_scheme = db.Column(db.Text)
    medical_scheme_applied_overseas = db.Column(db.Integer)
    funeral_assistance = db.Column(db.Integer)
    family_benefits = db.Column(db.Text)
    fund_schemes = db.Column(db.Text)
    home_provisions = db.Column(db.Text)
    snr_mgmt_benefits = db.Column(db.Integer)
    additional_benefits = db.Column(db.Text)
    direct_reports = db.Column(db.Integer)
    direct_reports_yes = db.Column(db.Text)
    difficulty_recruiting_expertise = db.Column(db.Integer)
    difficulty_recruiting_expertise_yes = db.Column(db.Text)
    emp_turnover = db.Column(db.Text)
    seperate_salary_scale = db.Column(db.Integer)
    seperate_salary_scale_yes = db.Column(db.Text)
...
class Allowance(db.Model):
    ...
    main_benchmark_job_id = db.Column(db.Integer, db.ForeignKey('main_benchmark_job.id'))
    survey_benchmark = db.relationship('Benchmark_job', backref='comp_benchmark_allowance' , lazy=True)
    comp_benchmark = db.relationship('Comparator_job', backref='comp_benchmark_allowance' , lazy=True)
...
class Base_salary(db.Model):
    ...
    main_benchmark_job_id = db.Column(db.Integer, db.ForeignKey('main_benchmark_job.id'))
    survey_benchmark = db.relationship('Benchmark_job', backref='comp_benchmark_base' , lazy=True)
    comp_benchmark = db.relationship('Comparator_job', backref='comp_benchmark_base' , lazy=True)
...
class Incentive(db.Model):
    ...
    main_benchmark_job_id = db.Column(db.Integer, db.ForeignKey('main_benchmark_job.id'))
    survey_benchmark = db.relationship('Benchmark_job', backref='comp_benchmark_incentive' , lazy=True)
    comp_benchmark = db.relationship('Comparator_job', backref='comp_benchmark_incentive' , lazy=True)
...
class Benefit(db.Model):
    ...
    main_benchmark_job_id = db.Column(db.Integer, db.ForeignKey('main_benchmark_job.id'))
    survey_benchmark = db.relationship('Benchmark_job', backref='comp_benchmark_benefit' , lazy=True)
    comp_benchmark = db.relationship('Comparator_job', backref='comp_benchmark_benefit' , lazy=True)
...
class Comparator_job(db.Model):
    ...
    comparator_id = db.Column(db.Integer, db.ForeignKey('survey_comparator.id'))
    benchmark_id = db.Column(db.Integer, db.ForeignKey('benchmark_job.id'))
    count = db.Column(db.Integer)
